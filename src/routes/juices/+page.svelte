...
<div class="">
  <div class="flex flex-col items-center pb-20">
    ...
    >
            ...
            <Dialog.Content>
              ...
              <div class="  lg:text-sm text-xs">
                <section>
                  ...
                  <ul>
                    <li>-نصف كوب اناناس طازج</li>
                    <li>-حبة مانجو طازجة</li>
                    <li>-1 م ك عسل (ويمكن زيادة سكر دايت)</li>
                    <li>-ثلج</li>
                    <li>-½ كوب ماء بارد</li>
                  </ul>
                </section>
                <section class="py-3">
                  ...
                  <ol class="">
                    ...
                    <li>3. تخلط جميع المقادير بالخلاط ثم نصفيهم</li>
      ...
      <div class=" w-[15vw] h-auto rounded-xl">
        <img src="/j2.JPG" alt="" class=" rounded-xl" />
        <span class="flex justify-center py-2 pr-2">
          <Dialog.Root>
            <Dialog.Trigger
              class="text-xs lg:w-[20vw] w-[18vw] lg:h-fit h-[5vh] {buttonVariants(
                { variant: 'outline' },
              )}">برتقال وجزر</Dialog.Trigger
            >
            <Dialog.Content>
              <Dialog.Header class="">
              ...
              <div class="  lg:text-sm text-xs">
                ...
                <section class="py-3">
                  ...
                  <ol class="">
                    ...
                    <li>2. يقشر البرتقال ويقطع
                      ونضيف عليه الماء وعصير الليمون</li>
                    <li>3. تخلط جميع المكونات بالخلاط الكهربائي</li>
                    <li></li>
                    <li>4. نسكبهم في كاسات التقديم</li>
      ...
      <div class=" w-[15vw] h-auto rounded-xl">
        <img src="/j3.JPG" alt="" class=" rounded-xl" />
        <span class="flex justify-center py-2 pr-2">
          <Dialog.Root>
            <Dialog.Trigger
              class="text-xs lg:w-[20vw] w-[18vw] lg:h-fit h-[5vh] {buttonVariants(
                { variant: 'outline' },
              )}">فراولة وموز</Dialog.Trigger
            >
            <Dialog.Content>
              <Dialog.Header class="">
              ...
              <div class="  lg:text-sm text-xs">
                <section>
                  <h2 class="text-secondary-foreground py-1">المكونات:</h2>
                  <ul>
                    <li>-نصف كوب من الفراولة</li>
                    <li>-موزة واحدة</li>
                    <li>-نصف كوب حليب لوز</li>
              ...
              <div class="  lg:text-sm text-xs">
                ...
                <section class="py-3">
                  ...
                  <ol class="">
                    ...
                    <li>2. ننزع اوراق النعناع ونغسلها جيدًا
                    </li>
      ...
      <div class=" w-[15vw] h-auto rounded-xl">
        <img src="/j4.JPG" alt="" class=" rounded-xl" />
        <span class="flex justify-center py-2 pr-2">
          <Dialog.Root>
            <Dialog.Trigger
              class="text-xs lg:w-[20vw] w-[18vw] lg:h-fit h-[5vh] {buttonVariants(
            ...
            <Dialog.Content>
              ...
              <div class="  lg:text-sm text-xs">
                ...
                <section class="py-3">
                  <h2 class=" text-secondary-foreground py-1">الطريقة:</h2>
                  <ol class="">
                    <li>1. ضع التوت الأزرق، والعنب الأحمر في وعاء الخلاط الكهربائي.</li>
                    <li> 2. أضيف الماء، واخلط المكونات جيداً حتى تتجانس تماماً.
                    </li>
                    <li>3. وزع مكعبات الثلج في أكواب التقديم، ثم صُب العصير وقدميه بارداً.
                    </li>
                  </ol>
                </section>
                <div class="py-3">
      ...
      <div class=" w-[15vw] h-auto rounded-xl">
        <img src="/j5.JPG" alt="" class=" rounded-xl" />
        <span class="flex justify-center py-2 pr-2">
          <Dialog.Root>
            <Dialog.Trigger
              class="text-xs lg:w-[20vw] w-[18vw] lg:h-fit h-[5vh] {buttonVariants(
                { variant: 'outline' },
              )}">كيوي وأناناس</Dialog.Trigger
            >
            <Dialog.Content>
              <Dialog.Header class="">
              ...
              <div class="  lg:text-sm text-xs">
                ...
                <section class="py-3">
                  ...
                  <ol class="">
                    ...
                    <li>2. ضع القطع في عصارة العصائر ومن ثم في كاسات.
                    </li>
                    <li>3. يمكن اضافة العسل إذا رغبت بذلك(واحسب السعرات مع 
                      المجموع)                      
                    </li>
                  </ol>
                </section>
