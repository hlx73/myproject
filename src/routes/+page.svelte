...
<div class="flex justify-center items-center">
    <div class=" bg-secondary flex justify-center items-center min-h-[100dvh] w-[80dvw] rounded-xl">
        <div class=" bg-[#c60660] rounded-3xl grid grid-cols-6 gap-1 p-6 font-semibold shadow-xl max-w-[1000rem]">
...
<div class="flex justify-end">
    <div
        class="bg-[rgb(218,27,72)] shadow-[0_20px_70px_-15px_rgba(0,0,0,0.3)]
         w-[20rem] absolute start-10 -translate-x-full pt-8 flex flex-col
        "
    >
        <img
            src="/"
            class="rounded-full w-40 h-50 mx-auto"
            alt="personal pic"
        />
        <div class="flex flex-col items-center gap-2">
            <h1 class="font-bold p-3 text-2xl">Hadeel</h1>
            <hr class="w-16 border-2 border-primary" />
            <h2 class="text-lg">AI student</h2>
            <div
                class=" w-full flex justify-center mt-5 text-secondary-foreground bg-cyan-600 border-"
            >
                <Button
                    variant="ghost"
                    size="icon"
                    href="https://x.com/_hadeell1"
                >
                    <svg
                        class="h-auro w-5"
